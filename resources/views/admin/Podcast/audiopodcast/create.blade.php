                        ...
                        <div class="w-1/2 mt-10 space-y-8 divide-y divide-gray-200">
                            <form method="POST" action="{{ route('audios.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="name" name="name" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out rounded-md sm:text-sm sm:leading-5" />
                                    </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="review" name="review" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out rounded-md sm:text-sm sm:leading-5" />
                                    </div>
                                    @error('review') <span class="text-sm text-red-400">{{ $message }}</span> @enderror
                                </div>
                                <div class="sm:col-span-6">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="price" name="price" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out rounded-md sm:text-sm sm:leading-5" />
                                    </div>
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="file" id="image" name="image" class="block w-full px-3 py-2 text-base leading-normal transition duration-150 ease-in-out rounded-md sm:text-sm sm:leading-5" />
                                    </div>
