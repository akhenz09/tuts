    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="p-2 overflow-hidden bg-white shadow-sm sm:rounded-lg">
            ...
            <div class="flex justify-end p-2">
                ...
                <a href="{{ route('audio.create') }}" class="px-4 py-2 bg-green-700 rounded-md hover:bg-green-500">Add</a>
            </div>
                ...
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Audio</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <img src="{{ asset('storage/' . $audio->audio) }}" alt="Landing Page Image" class="max-h-32">
                                </div>
                            </td>
                            {{--<td>
